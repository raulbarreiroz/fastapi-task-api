...
description: Verify that a Markdown file has correct formatting — headings, lists, links, code blocks, spacing, and consistent style. Use when reviewing or polishing README.md and other Markdown documentation.
user-invocable: true
---
